...
class Vision:
    ...
    def getClickPoints(self , rectangles):
        points = []
    ...
    def drawCrosshairs(self , haystack_img , points):
        line_color = (255,0,255)
        marker_type = cv.MARKER_CROSS
        for (x,y) in points:
            cv.drawMarker(haystack_img , (x,y) , line_color , marker_type)
        return haystack_img
